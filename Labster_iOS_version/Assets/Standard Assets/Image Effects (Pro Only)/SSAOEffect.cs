...
public class SSAOEffect : MonoBehaviour
{
	...
	public float m_OcclusionIntensity = 1.0f;
	public int m_Blur = 4;
	...
	public void UpdateShader(){
		if(debugAO){
			Shader.EnableKeyword("DebugAO_ON");
			Shader.DisableKeyword("DebugAO_OFF");
		}
		else{
			Shader.EnableKeyword("DebugAO_OFF");
			Shader.DisableKeyword("DebugAO_ON");
		}
	}
	...
	void OnRenderImage (RenderTexture source, RenderTexture destination)
	{
		...
		m_Radius = Mathf.Clamp (m_Radius, 0.05f, 2.0f);
